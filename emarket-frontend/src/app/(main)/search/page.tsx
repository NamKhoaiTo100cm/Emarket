    ...
    return (
        <div className="mx-5 md:mx-10 flex flex-row gap-6 p-0">
            <div className="border border-red flex flex-col gap-4 basis-1/5">
                ...
                <div>
                    <h1 className="text-md font-semibold mb-2">
                        Đánh giá từ {rating} sao trở lên
                    </h1>
            ...
            <div className="basis-4/5">
                {products && products.length === 0 && res && (
                    <div className="flex justify-center items-center h-screen">
                        <p>
                            Không tìm thấy sản phẩm cho từ khóa{" "}
                            <span className="text-red-500">"{keyword}"</span> danh mục{" "}
                ...
                {!(products && products.length === 0 && res) && (
                    <p className="text-md font-semibold mb-2">
                        Có {products.length} kết quả cho từ khóa{" "}
